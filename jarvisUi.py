...
class Ui_jarvisUi(object):
    def setupUi(self, jarvisUi):
        ...
        jarvisUi.resize(1395, 825)
        self.centralwidget = QtWidgets.QWidget(jarvisUi)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(0, 0, 1421, 821))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("../../PycharmProjects/firstpythonProject/venv/gif1.gif"))
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(1010, 720, 93, 28))
        font = QtGui.QFont()
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(1110, 720, 93, 28))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(34, 15, 411, 111))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("../../PycharmProjects/firstpythonProject/venv/gif2.gif"))
        self.label_2.setObjectName("label_2")
        self.textBrowser = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(860, 20, 231, 61))
        font = QtGui.QFont()
...
"font=size:20px;")
        ...
        self.textBrowser_2.setGeometry(QtCore.QRect(1095, 20, 251, 61))
        font = QtGui.QFont()
        font.setFamily("Nirmala UI")
        font.setPointSize(16)
        font.setBold(True)
